...
public class TestRedirects {
    ...
    public void testRedirects() {
        ...
        LOGGER.info(pps.getRedirects()+"8");
        try {
            sendGet(pps.getRedirects()+"8");

            LOGGER.info("Test: testRedirects with value, verify response http code");
            ...
            LOGGER.info("Test: testRedirects, verify body i`snt empty. \n Details :" + responseBody);
